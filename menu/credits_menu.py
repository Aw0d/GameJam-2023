...
class CreditsMenu():
    def __init__(self, screen : pg.Surface):
        ...
        text1 = Text("pixabay.com", (screen.get_width()/1.6, 460), 15, (0, 0, 0), "ressources/fonts/TypefaceMarioWorldPixelFilledRegular-rgVMx.ttf", 800)
        text2 = Text("CAMUS Mathieu \n KALIC Benjamin \n ARCHILA Cesar \n KAZI-TANI Sami", (screen.get_width()/1.6, 305), 15, (0, 0, 0), "ressources/fonts/TypefaceMarioWorldPixelFilledRegular-rgVMx.ttf", 800)
        text3 = Text("KAZI-TANI Sami", (screen.get_width()/1.02, 260), 15, (0, 0, 0), "ressources/fonts/TypefaceMarioWorldPixelFilledRegular-rgVMx.ttf", 800)
        text4 = Text("giventofly.github.io/pixelit \n getemoji.com \n www.pngwing.com", (screen.get_width()/1.02, 485), 15, (0, 0, 0), "ressources/fonts/TypefaceMarioWorldPixelFilledRegular-rgVMx.ttf", 800)
        text5 = Text("www.fontspace.com", (screen.get_width()/1.6, 655), 15, (0, 0, 0), "ressources/fonts/TypefaceMarioWorldPixelFilledRegular-rgVMx.ttf", 800)
        text6 = Text("LOSER POV", (screen.get_width()/1.02, 655), 15, (0, 0, 0), "ressources/fonts/TypefaceMarioWorldPixelFilledRegular-rgVMx.ttf", 800)
